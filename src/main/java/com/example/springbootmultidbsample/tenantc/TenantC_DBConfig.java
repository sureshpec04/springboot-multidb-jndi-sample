...
public class TenantC_DBConfig {
	...
	@Bean(name = "tenantCDataSource" , destroyMethod="")
	public DataSource dataSource() throws Exception {
		JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
		dataSourceLookup.setResourceRef(true);
		return dataSourceLookup.getDataSource("java:jboss/datasources/NationwideDB"); //JNDI name should match EAP 7 datasource jndi name
	}
  ...
  @ConditionalOnBean( name = "tenantCDataSource" )
